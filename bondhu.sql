...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2129358115ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bondhu&table=users">`bondhu`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bondhu&table=posts">`bondhu`.`posts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=alanmvc&table=posts">`alanmvc`.`posts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pdo&table=posts">`pdo`.`posts`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="4b22794722367167713148614a416537">
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="bondhu" targettable="users">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users` ORDER BY `id`  ASC </span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="bondhu" targettable="posts">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE users AUTO_INCREMENT = 1;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="bondhu" targettable="posts">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE posts AUTO_INCREMENT = 1;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="bondhu" targettable="posts">
                            <div class="action_content">
