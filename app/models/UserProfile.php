...
class UserProfile extends Database
{
    ...
    {
        $this->db->query("SELECT id, name, email, username, profile_img, bio, company_name, location, birthdate, relationship, is_verified, created_at FROM users WHERE id = :user_id");
